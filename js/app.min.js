...
$(function () {
    ...
    $('.applyDataTable').DataTable({
        ...
        initComplete: function (settings, json) {
            this.closest('.dataTables_wrapper').siblings('div.dataTables_info').insertBefore(this);
            console.log(this.closest('.dataTables_wrapper').siblings('div.dataTables_info'), settings, json)
        }
    });
    ...
    $('#pick_datetime').datetimepicker({
        ...
        onShow:function( ct ){
            this.setOptions({
                maxDate:jQuery('#drop_datetime').val()?jQuery('#drop_datetime').val():false
            })
        },
        step:30
    });
    $('#drop_datetime').datetimepicker({
        format:'Y-m-d H:i',
        onShow:function( ct ){
            this.setOptions({
                minDate:jQuery('#pick_datetime').val()?jQuery('#pick_datetime').val():false
            })
        },
        step:30
    });
